...
<html>
	<head>
		...
		<link rel="stylesheet" href="/ZadaniePbaw3/assets/css/main.css" />
		<noscript><link rel="stylesheet" href="/ZadaniePbaw3/assets/css/noscript.css" /></noscript>
	</head>
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<nav>
							<ul>
								<li><a href="#kalk">Kalkulator</a></li>
								<!--kolejne kotwice do wykorzystania kidyś
					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="kalk">
								...
								<span class="image main"><img src="images/pic01.jpg" alt="error in loading image" /></span>
								<form action="<?php print(_APP_ROOT);?> method="post">
									<fieldset>
